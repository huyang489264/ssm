...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<script>
            ...
            $(function () {
                //页面加载就从pageInfo获取pageSize,通过id值等于pageSize获取需要修改默认的下拉框对象,添加"selected"属性
                <%--$("#${pageInfo.pageSize}").prop("selected",true);--%>
                //页面加载就从pageInfo获取pageSize,通过value值等于pageSize获取需要修改默认的下拉框对象,添加"selected"属性
                $("option[value='${pageInfo.pageSize}']").prop("selected",true);
            });
